# AmpleVoiceAI SDK Examples

Runnable examples of the AmpleVoiceAI SDK in Python and TypeScript.
...
export AMPLEVOICE_API_ENDPOINT=http://localhost:8000
export AMPLEVOICE_API_TOKEN=sk-...
