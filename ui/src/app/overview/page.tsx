            ...
            <div className="max-w-4xl mx-auto">
                ...
                <Card className="mb-8">
                    <CardHeader>
                        ...
                        <CardDescription className="text-lg mt-2">
                            {isOSSMode ? (
                                <>
                                    Your voice AI platform. Build and deploy conversational agents.
                                </>
                            ) : (
                ...
                <Card className="mt-8">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Get help and learn more about AmpleVoiceAI
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="flex flex-wrap gap-4">
                            <Button asChild variant="outline">
                                <a
                                    href="https://docs.amplevoice.com"
                                    target="_blank"
                            ...
                            <Button asChild variant="outline">
                                <a
                                    href="https://github.com/amplevoice-hq/amplevoice/issues"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    Report an Issue
