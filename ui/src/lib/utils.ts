...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. app.amplevoice.com). The route will set the
  ...
  // superadmin.amplevoice.com we want to switch to app.amplevoice.com. For any other domain
