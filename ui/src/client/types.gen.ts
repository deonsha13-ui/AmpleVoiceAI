...
export type ClientOptions = {
    baseUrl: 'https://app.amplevoice.com' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., amplevoice_staging)
     */
...
export type ByokPipelineAiModelConfiguration = {
    ...
    embeddings?: ({
        ...
        provider: 'amplevoice';
    } & AmpleVoiceAIEmbeddingsConfiguration) | null;
};
...
export type CurrentUsageResponse = {
    ...
    period_end: string;
    /**
     * Used AmpleVoiceAI Tokens
     */
    used_amplevoice_tokens: number;
    /**
...
export type DailyUsageBreakdownResponse = {
    ...
    /**
     * Total AmpleVoiceAI Tokens
     */
    total_amplevoice_tokens: number;
    /**
     * Currency
     */
    currency?: string | null;
 ...
 * AmpleVoiceAI
 */
export type AmpleVoiceAIEmbeddingsConfiguration = {
    /**
     * Provider
     */
    provider?: 'amplevoice';
     ...
     * Model
     *
     * AmpleVoiceAI-managed embedding model.
     */
    model?: string;
};
 ...
 * AmpleVoiceAI
 */
export type AmpleVoiceAILlmService = {
    /**
     * Provider
     */
    provider?: 'amplevoice';
     ...
     * Model
     *
     * AmpleVoiceAI-hosted model tier.
     */
    model?: string;
};
 ...
 */
export type AmpleVoiceAIManagedAiModelConfiguration = {
    /**
     * Api Key
     */
    api_key: string;
 ...
 * AmpleVoiceAI
 */
export type AmpleVoiceAISttService = {
    /**
     * Provider
     */
    provider?: 'amplevoice';
 ...
 * AmpleVoiceAI
 */
export type AmpleVoiceAITtsService = {
    /**
     * Provider
     */
    provider?: 'amplevoice';
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. AmpleVoiceAI maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by AmpleVoiceAI from fixed values or workflow context templates.
     */
...
export type OrganizationAiModelConfigurationV2 = {
     ...
     * Mode
     */
    mode: 'amplevoice' | 'byok';
    amplevoice?: AmpleVoiceAIManagedAiModelConfiguration | null;
...
export type WorkflowRunUsageResponse = {
    ...
    created_at: string;
    /**
     * AmpleVoiceAI Token Usage
     */
    amplevoice_token_usage: number;
    /**
...
export type GetVoicesApiV1UserConfigurationsVoicesProviderGetData = {
    ...
    path: {
         ...
         * Provider
         */
        provider: 'elevenlabs' | 'deepgram' | 'sarvam' | 'cartesia' | 'amplevoice' | 'rime';
    };
    query?: {
        /**
         * Model
