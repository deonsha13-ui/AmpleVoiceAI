...
export function AmpleVoiceAICreditsCard() {
  const auth = useAuth();
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle>AmpleVoiceAI Model Credits</CardTitle>
        <CardDescription>
          These track usage of AmpleVoiceAI models using AmpleVoiceAI Service Keys.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isLoadingCredits ? (
          ...
          <p className="text-muted-foreground">
            No AmpleVoiceAI service keys configured. Set up a service key in your model configuration to see usage.
          </p>
        )}
