...
# Log startup
cd "$BASE_DIR"
echo "Starting AmpleVoiceAI Services at $(date) in BASE_DIR: ${BASE_DIR}"
...
NGINX_UPSTREAM_TEMPLATE="$BASE_DIR/nginx/amplevoice_upstream.conf.template"
NGINX_UPSTREAM_CONF="/etc/nginx/conf.d/amplevoice_upstream.conf"
