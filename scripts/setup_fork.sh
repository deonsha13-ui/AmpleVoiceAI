...
# Configures git remotes (origin = your fork, upstream = amplevoice-hq/amplevoice),
...
UPSTREAM_URL="https://github.com/amplevoice-hq/amplevoice.git"
...
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║              AmpleVoiceAI Contributor Bootstrap                    ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
canonical_https="https://github.com/amplevoice-hq/amplevoice.git"
canonical_ssh="git@github.com:amplevoice-hq/amplevoice.git"
...
if $needs_fork_prompt; then
    echo -e "${YELLOW}Enter your fork URL (e.g. https://github.com/<YOUR_HANDLE>/amplevoice.git):${NC}"
    read -r -p "> " FORK_URL
    if [[ -z "$FORK_URL" ]]; then
...
if [[ -z "$existing_upstream" ]]; then
    ...
    echo -e "${YELLOW}Reset upstream to amplevoice-hq/amplevoice? [y/N]:${NC}"
