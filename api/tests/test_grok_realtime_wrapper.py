...
def _make_service() -> AmpleVoiceAIGrokRealtimeLLMService:
    service = AmpleVoiceAIGrokRealtimeLLMService(api_key="test-key")
...
def test_factory_creates_amplevoice_grok_realtime_service():
    ...
    assert isinstance(service, AmpleVoiceAIGrokRealtimeLLMService)
