...
class _TestAmpleVoiceAIGeminiLiveLLMService(AmpleVoiceAIGeminiLiveLLMService):
    """AmpleVoiceAI Gemini service with client creation stubbed for unit tests."""
...
def _make_service() -> _TestAmpleVoiceAIGeminiLiveLLMService:
    service = _TestAmpleVoiceAIGeminiLiveLLMService(api_key="test-key")
