"""Tests for CAMB AI TTS integration into AmpleVoiceAI.
...
class TestServiceFactoryCamb:
    def test_create_tts_service_camb(self):
        ...
        amplevoice_modules = [
            "pipecat.services.amplevoice",
            "pipecat.services.amplevoice.llm",
            "pipecat.services.amplevoice.stt",
            "pipecat.services.amplevoice.tts",
            "pipecat.utils.text.xml_function_tag_filter",
        ]
        mocks = {}
        for mod in amplevoice_modules:
