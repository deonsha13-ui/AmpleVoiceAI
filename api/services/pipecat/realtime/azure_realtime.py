"""AmpleVoiceAI subclass of pipecat's Azure OpenAI Realtime LLM service.

Layers AmpleVoiceAI engine integration quirks (mute gating, TTSSpeakFrame greeting
trigger, LLMMessagesAppendFrame handling, deferred tool calls) onto pipecat's
AzureRealtimeLLMService, mirroring what AmpleVoiceAIOpenAIRealtimeLLMService does
...
class AmpleVoiceAIAzureRealtimeLLMService(AzureRealtimeLLMService):
    """Azure OpenAI Realtime with AmpleVoiceAI engine integration quirks.

    Extends AzureRealtimeLLMService with the same AmpleVoiceAI-specific behaviours
    added to AmpleVoiceAIOpenAIRealtimeLLMService:
