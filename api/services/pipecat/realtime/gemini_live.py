"""AmpleVoiceAI subclass of pipecat's Gemini Live LLM service.
...
class AmpleVoiceAIGeminiLiveLLMService(GeminiLiveLLMService):
    """Gemini Live with AmpleVoiceAI engine integration quirks. See module docstring."""
    ...
    # ------------------------------------------------------------------
    # Context lifecycle: AmpleVoiceAI pre-populates self._context via the engine,
    ...
    # init-instruction reconciliation (AmpleVoiceAI updates system_instruction at
    ...
    # kick off bot turns in the AmpleVoiceAI flow.
    # ------------------------------------------------------------------
