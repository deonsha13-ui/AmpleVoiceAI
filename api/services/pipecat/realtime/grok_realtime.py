"""AmpleVoiceAI subclass of pipecat's Grok Realtime LLM service.
...
- **finalized=True on TranscriptionFrame** for parity with AmpleVoiceAI's other
  realtime providers.
"""
...
class AmpleVoiceAIGrokRealtimeLLMService(GrokRealtimeLLMService):
    """Grok Realtime with AmpleVoiceAI engine integration quirks."""
