...
This module implements the telephony provider abstraction for AmpleVoiceAI AI. For user-facing documentation, see the [Mintlify docs](https://docs.amplevoice.com/integrations/telephony/overview).
...
See the [Custom Provider Guide](https://docs.amplevoice.com/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](https://docs.amplevoice.com/integrations/telephony/overview)
- [Twilio Integration](https://docs.amplevoice.com/integrations/telephony/twilio)
- [Custom Providers](https://docs.amplevoice.com/integrations/telephony/custom)
- [Webhooks Guide](https://docs.amplevoice.com/integrations/telephony/webhooks)
