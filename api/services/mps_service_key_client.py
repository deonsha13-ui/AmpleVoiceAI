...
from api.constants import DEPLOYMENT_MODE, AMPLEVOICE_MPS_SECRET_KEY, MPS_API_URL
...
class MPSServiceKeyClient:
    ...
    async def report_platform_usage(
        ...
        *,
        ...
        """Report hosted AmpleVoiceAI platform usage for a completed workflow run."""
        if DEPLOYMENT_MODE == "oss":
    ...
    def validate_service_key(
        ...
        """
        Synchronously validate a AmpleVoiceAI service key by checking usage via MPS.
        ...
        try:
            ...
            logger.warning("Failed to validate AmpleVoiceAI service key via MPS")
            return False
