...
class UserConfigurationValidator:
    def __init__(self):
        self._validator_map = {
            ...
            ServiceProviders.AMPLEVOICE.value: self._check_amplevoice_api_key,
    ...
    def _check_amplevoice_api_key(self, model: str, api_key: str) -> bool:
        if api_key.startswith("dgr"):
            raise ValueError(
                "You provided a AmpleVoiceAI API key (dgr...) instead of a service key. "
