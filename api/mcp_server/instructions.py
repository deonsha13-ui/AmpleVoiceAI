...
AMPLEVOICE_MCP_INSTRUCTIONS = """\
You build and edit AmpleVoiceAI voice-AI workflows by emitting TypeScript that uses the `@amplevoice/sdk` package. Workflows are stored as JSON; this server projects them to TypeScript for editing and parses them back on save.
...
1. `search_docs` — use first for keyword or acronym lookup when the user is asking how AmpleVoiceAI works or how to configure something.
