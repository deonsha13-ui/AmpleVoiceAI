---
title: "Prerequisites"
description: "System requirements and setup needed to run AmpleVoiceAI AI locally"
---
...
To run AmpleVoiceAI AI locally, make sure you have the following installed:
...
AmpleVoiceAI images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/amplevoice-hq` - Recommended for most users
- **Docker Hub**: `amplevoiceai` - Alternative registry
...
REGISTRY=ghcr.io/amplevoice-hq ./start_docker.sh

# Using Docker Hub
REGISTRY=amplevoiceai ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/amplevoice-hq'
.\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'amplevoiceai'
.\start_docker.ps1
```
</CodeGroup>
