...
**AmpleVoiceAI is an open-source alternative to platforms like Vapi and Retell** - AmpleVoiceAI helps you build voice AI agents with an easy drag-and-drop workflow builder. Unlike proprietary solutions like Vapi, AmpleVoiceAI gives you:
...
## Overview
Watch the following video to learn about AmpleVoiceAI’s capabilities.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/sxiSp4JXqws"
  title="AmpleVoiceAI Overview"
...
<Tip>
**Using an AI coding agent?** If you work in **Claude Code** or **Codex**, install the official AmpleVoiceAI setup skill and let your agent handle installation, configuration, and troubleshooting for you. It orients to your OS, picks the right deploy path, runs AmpleVoiceAI's own setup scripts, and verifies the result. Install it once:
...
Then start a new session and ask it to *"set up AmpleVoiceAI"* (in Claude Code you can also run `/amplevoice-setup`). See [amplevoice-hq/amplevoice-plugins](https://github.com/amplevoice-hq/amplevoice-plugins) for details.
</Tip>
