---
title: "Overview"
description: "Interact with AmpleVoiceAI programmatically via the REST API"
---
...
```
https://your-amplevoice-instance/api/v1
```

If you are using the hosted version, the base URL is `https://app.amplevoice.com/api/v1`.
...
```bash
curl -X POST https://your-amplevoice-instance/api/v1/workflow/create/definition \
...
```bash
curl https://your-amplevoice-instance/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-amplevoice-instance",
  "deployment_mode": "oss",
  "auth_provider": "local"
}
```
