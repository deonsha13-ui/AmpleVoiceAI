...
description: "Connect AmpleVoiceAI to Tuner — the observability, simulation, and testing layer for voice"
---
...
- A AmpleVoiceAI voice agent workflow

## Setup

### 1. Create an agent in Tuner

Log in to [Tuner](https://app.usetuner.ai) and create a new agent. When configuring the agent, set the **Provider** to **Custom API** — this is required for the AmpleVoiceAI integration.
...
In your AmpleVoiceAI workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Tuner**.

<img
  src="/images/tuner-amplevoice-workflow-builder.png"
  alt="AmpleVoiceAI voice workflow builder — click Add node"
/>
...
<img
  ...
  alt="AmpleVoiceAI Integrations panel showing QA Analysis, Tuner, and Webhook"
/>
...
<img
  ...
  alt="AmpleVoiceAI Edit Tuner modal with credential fields and Enabled toggle"
/>
