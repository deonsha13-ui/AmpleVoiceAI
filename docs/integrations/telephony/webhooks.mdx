...
description: "How AmpleVoiceAI AI handles telephony webhooks and audio streaming"
---

## Overview

AmpleVoiceAI AI uses webhooks to communicate with telephony providers for call events and audio streaming. Webhooks are automatically configured when you initiate calls.
