...
AMPLEVOICE_DEPLOY_PROJECT_DIR="$SCRIPT_DIR"
...
amplevoice_info "Running AmpleVoiceAI remote preflight..."
amplevoice_prepare_remote_install "$SCRIPT_DIR"
docker compose config -q
amplevoice_success "✓ amplevoice-init preflight validated"
